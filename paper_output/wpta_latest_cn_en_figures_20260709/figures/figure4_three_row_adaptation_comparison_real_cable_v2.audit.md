...
- Real imagery: the MVTec cable test image is embedded as the left input in every row; GT/fixed/direct/Ours result panels use local real assets.
...
- Difference placement: the fixed, direct-evidence, and Ours rows differ inside the method space itself through patch selection, evidence routing, and prototype update behavior.

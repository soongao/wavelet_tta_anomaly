...
- Appendix Table B1a/B1b 尚未完成协议核验，只能作为 protocol-reference，不得用于外部最佳方法结论。
...
本表仅作 protocol-reference。外部方法数字来自另一份 `main.tex` 的表格摘录，当前系统数字来自本项目 CSV。由于 split、backbone、输入尺寸、后处理和 evaluation script 尚未逐项核验，本表暂不加粗 best values，也不能用于外部最佳方法结论。

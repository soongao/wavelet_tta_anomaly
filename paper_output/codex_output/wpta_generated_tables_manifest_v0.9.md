...
本索引用于锁定当前已经可以由现有实验结果支撑的论文表格。中文表格稿见 `outputs/wpta_generated_tables_v0.9.md`，LaTeX 版本见 `outputs/wpta_generated_tables_latex_v0.9.tex`。
...
|---|---|---|---|
| Appendix Table B1a. 五数据集外部方法 pixel-level 协议参考 | `tab:protocol_reference_pixel` | protocol-reference only | 外部方法协议未逐项核验，不得用于主文排名或 SOTA 结论 |
...
- 已生成表格文件：`outputs/wpta_generated_tables_v0.9.md`
- 已生成 LaTeX 文件：`outputs/wpta_generated_tables_latex_v0.9.tex`
...
- 已扫描并确认表格包中不含 `runtime`、`normal stability`、`expected_pass`、`SOTA`、`state-of-the-art` 或旧表格版本引用。

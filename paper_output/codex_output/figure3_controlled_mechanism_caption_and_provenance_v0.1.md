...
selected evidence, and Ours map. The direct wavelet cue column is omitted to keep
...
real model-output examples, Ours keeps final anomaly scoring tied to calibrated
...
- Supported: qualitative evidence for the controlled MVTec/VisA Ours mechanism.
...
- Not supported: attribution of MPDD or BTAD final-system gains to Ours.

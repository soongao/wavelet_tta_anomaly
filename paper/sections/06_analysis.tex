...
GlobalRef adds a second diagnostic check. It is stronger than direct fusion,
so it is not a broken control, but it remains below \method{} on both datasets,
especially in Pixel AUPRO. This supports the narrower claim that the reference
should be conditioned on the current image rather than fixed globally.

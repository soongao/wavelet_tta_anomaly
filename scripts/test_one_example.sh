...
#         CUDA_VISIBLE_DEVICES=${device} python scripts/evaluate/test.py --dataset mvtec \
...
#         CUDA_VISIBLE_DEVICES=${device} python scripts/evaluate/test.py --dataset visa \
...
for i in "${!depth[@]}";do
    ...
    ## train on the VisA dataset
        ...
        CUDA_VISIBLE_DEVICES=${device} python scripts/evaluate/test_one_example.py \
